    ...
    <div className="min-h-screen flex bg-[#08090A] text-[#EAEAEA] selection:bg-white/10 selection:text-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-20 border-r border-white/[0.03] bg-[#08090A] relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
          <div className="absolute top-[20%] left-[10%] w-[500px] h-[500px] bg-indigo-500/5 blur-[120px] rounded-full" />
          ...
          <div className="max-w-md">
            ...
            >
              <h1 className="text-5xl font-semibold text-white mb-8 tracking-tight leading-[1.1]">
                Built for <br />
                <span className="text-gray-500">modern teams.</span>
              </h1>
              <p className="text-lg text-gray-500 font-light leading-relaxed mb-16 max-w-sm">
                Join thousands of teams shipping better software with Trackly's streamlined workspace.
              </p>
            </motion.div>

            <div className="space-y-8">
              {[
                { title: "Team focus", desc: "Keep everyone aligned on the mission." },
                { title: "Powerful workflows", desc: "Automate the busy work." },
                { title: "Cloud performance", desc: "Fast, secure, and always synced." }
              ].map((item, i) => (
                <motion.div
          ...
          >
            <div className="mb-10">
              ...
              <p className="text-[14px] text-gray-500 font-medium">
                Set up your profile and start building.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                <label className="text-[12px] font-medium text-gray-500 ml-1">Full name</label>
                <div className="relative group">
                  <input
                    ...
                    placeholder="Aman Shishodia"
                  />
                  <User size={14} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-700 group-focus-within:text-gray-500 transition-colors" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-[12px] font-medium text-gray-500 ml-1">Password</label>
                <div className="relative group">
                  <input
            ...
            <div className="mt-12 pt-8 border-t border-white/[0.03]">
              <p className="text-[13px] text-gray-600 text-center">
                ...
                <Link to="/login" className="text-gray-300 hover:text-white transition-colors font-semibold ml-1">
                  Sign in
                </Link>
              </p>
            </div>
